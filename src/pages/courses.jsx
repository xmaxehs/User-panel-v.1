...
import { SidebarButtons, CoursesCards } from "../components";
      ...
      >
        <div className="flex flex-row mx-3">
          <div className="flex flex-col w-2/3 md:w-full md:h-screen">
            ...
            <div className="w-full h-full md:h-min bg-gray-100 p-7 rounded-3xl dark:bg-gray-900 xl:max-h-[540px] overflow-y-scroll shrink-0">
              <CoursesCards />
            </div>
          </div>
