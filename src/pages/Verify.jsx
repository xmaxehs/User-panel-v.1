      ...
      >
        <div className="flex flex-row mx-3">
          <div className="flex flex-col w-2/3 md:w-full md:h-screen">
                        ...
                        <Menu.Item>
                          <div className="flex flex-row items-center mx-4">
                            ...
                            <div className="flex flex-col gap-y-1 p-2">
                              <p className="dark:text-gray-100 text-slate-800">
                                {t("userBtn.username")}
                              </p>
                              <p className="dark:text-gray-100 text-slate-800">
                                {t("userBtn.balance")}
            ...
            <div className="w-full h-full md:h-min bg-gray-100 p-7 rounded-3xl dark:bg-gray-900 xl:max-h-[540px] shrink-0">
              <div className="bg-white dark:bg-gray-800 p-3.5 md:p-4.5 rounded-2xl mb-3">
                ...
                <div>
                  <div className="flex items-center justify-between flex-wrap gap-y-3 my-2 p-3 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-colors">
                    <div className="flex items-center">
                      ...
                      <svg
                        className="w-5 h-5 mx-2 text-gray-800 dark:text-white"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 21 21"
